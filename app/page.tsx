...
import { ArrowRight, CheckCircle, Menu, MoonIcon, SunIcon, Star, Check } from "lucide-react"
export default function Component() {
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <header className="px-4 lg:px-6 h-14 flex items-center  bg-white border-b fixed border-b-slate-200 w-full">
      ...
      <main className="flex-1">
        <section className="w-full py-10 md:py-20 lg:py-30 xl:py-48">
          <div className="container px-4 md:px-6 flex flex-row">
            <div className="flex flex-col space-y-4 w-1/2">
              <div className="space-y-2">
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl/none">
                  Saas Template with Supabase and Stripe
                </h1>
                <p className=" text-muted-foreground md:text-xl">
                  Authenticate users, manage subscriptions
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-muted-foreground/10 p-4 rounded-lg">
                ...
                <p className="text-muted-foreground text-center">Seamlessly integrate with your existing systems.</p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-muted-foreground/10 p-4 rounded-lg">
                <div className="p-2 bg-primary/10 rounded-full">
                  <CheckCircle className="h-6 w-6 text-primary" />
                ...
                <p className="text-muted-foreground text-center">Gain insights with our powerful analytics tools.</p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-muted-foreground/10 p-4 rounded-lg">
                <div className="p-2 bg-primary/10 rounded-full">
                  <CheckCircle className="h-6 w-6 text-primary" />
                ...
                <p className="text-muted-foreground text-center">Our team is always here to help you succeed.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-8">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-2">"The customer support is unparalleled. They're always there when you need them."</p>
